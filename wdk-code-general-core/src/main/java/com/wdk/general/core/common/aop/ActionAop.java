 ...
 */
package com.wdk.general.core.common.aop;
...
public class ActionAop {
    ...
    @Pointcut("execution(* com.wdk.general.core.service..*(..))")
     ...
     * @param joinPoint
     */
    @Before(value = "execution(* com.wdk.general.core.web..*(..))")
     ...
     * @param joinPoint
     */
    @AfterReturning(value = "execution(* com.wdk.general.core.web..*(..))", returning = "result")
