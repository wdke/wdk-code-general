...
public class PomServiceImpl implements PomService {
    ...
    public void pom() {
        ...
        String fileName=filePath+"/pom.xml";
        ...
        root.addElement("groupId").addText("com.wdk");
        root.addElement("artifactId").addText("wdk-code-general-core-test");
        root.addElement("version").addText("0.0.1-SNAPSHOT");
        root.addElement("name").addText("wdk-code-general-core-test");
        root.addElement("description").addText("Demo project for Spring Boot");
        root.addElement("packaging").addText("java");
        ...
        properties.addElement("java.version").addText("1.8");
