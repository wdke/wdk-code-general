...
public class Nideshop_cartExample {
    ...
    public Nideshop_cartExample sumId() {
        this.sumCol="id";
        return this;
    }

    public Nideshop_cartExample sumUserId() {
        this.sumCol="user_id";
        return this;
    }

    public Nideshop_cartExample sumSessionId() {
        this.sumCol="session_id";
        return this;
    }

    public Nideshop_cartExample sumGoodsId() {
        this.sumCol="goods_id";
        return this;
    }

    public Nideshop_cartExample sumGoodsSn() {
        this.sumCol="goods_sn";
        return this;
    }

    public Nideshop_cartExample sumProductId() {
        this.sumCol="product_id";
        return this;
    }

    public Nideshop_cartExample sumGoodsName() {
        this.sumCol="goods_name";
        return this;
    }

    public Nideshop_cartExample sumMarketPrice() {
        this.sumCol="market_price";
        return this;
    }

    public Nideshop_cartExample sumRetailPrice() {
        this.sumCol="retail_price";
        return this;
    }

    public Nideshop_cartExample sumNumber() {
        this.sumCol="number";
        return this;
    }

    public Nideshop_cartExample sumGoodsSpecifitionIds() {
        this.sumCol="goods_specifition_ids";
        return this;
    }

    public Nideshop_cartExample sumChecked() {
        this.sumCol="checked";
        return this;
    }

    public Nideshop_cartExample sumListPicUrl() {
        this.sumCol="list_pic_url";
        return this;
    }

    public Nideshop_cartExample sumGoodsSpecifitionNameValue() {
        this.sumCol="goods_specifition_name_value";
        return this;
    }
    ...
    public Nideshop_cartExample page(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
        return this;
    }
